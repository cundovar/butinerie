	...
	public function output( $event_id = 0, $atts = array() ){
		...
		if ( ( true === $this->is_editor_mode || ( $atts['edit_mode'] ?? false ) ) && empty( $html ) ) {
			...
			$html = '<div class="mec-content-notification"><p>'
				.'<span>'. esc_html__('To show this widget, you need to set "Event Gallery" for your latest event.', 'mec').'</span>'
				. '<a href="https://webnus.net/dox/modern-events-calendar/add-event/#Event_Gallery" target="_blank">' . esc_html__('Read More', 'mec') . ' </a>'
			.'</p></div>';
		}
