	...
	public function output( $event_id = 0, $atts = array() ){
		...
		if ( true === $this->is_editor_mode && !$is_rsvp_enabled ) {
			...
			$html = '<div class="mec-content-notification">
					<p>'
						.'<span>'
							. esc_html__('To show this widget, you need to enable "RSVP" module.', 'mec')
						.'</span>'
						.'<a href="https://webnus.net/dox/modern-events-calendar/rsvp-events-addon/" target="_blank">' . esc_html__('Read More', 'mec') . ' </a>'
					.'</p>'
				.'</div>';
