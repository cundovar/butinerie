	...
	public function output( $event_id = 0, $atts = array() ){
		...
		if ( !$display_reason && $this->is_editor_mode() ) {
			...
			$html = '<div class="mec-content-notification"><p>'
					.'<span>'. esc_html__('To show this widget, you need to set "Cancellation Reason" for your latest event.', 'mec').'</span>'
					. '<a href="https://webnus.net/dox/modern-events-calendar/add-event/#SEO_SchemaEvent_Status" target="_blank">' . esc_html__('Read More', 'mec') . ' </a>'
				.'</p></div>';
		} else {
