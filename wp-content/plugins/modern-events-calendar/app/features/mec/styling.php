                ...
                <div class="mec-container">
                    <form id="mec_styling_form">
                        ...
                        <!-- Colorskin -->
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_primary_border_radius"><?php esc_html_e('Primary border-radius', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php esc_html_e('Primary border-radius', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('Customize the border-radius for wrappers, event items and event modules', 'mec'); ?></p></div>
                                        </div>
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_secondary_border_radius"><?php esc_html_e('Secondary border-radius', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php esc_html_e('Secondary border-radius', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('Customize the border-radius buttons and other smaller elements.', 'mec'); ?></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
