...
class MEC_feature_locations extends MEC_base
{
    ...
    ?>
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_tel"><?php esc_html_e('Location Phone', 'mec'); ?></label>
            </th>
            <td>
                <input type="tel" placeholder="<?php esc_attr_e('Location Phone (Optional)', 'mec'); ?>" name="tel" id="mec_tel" value="<?php echo esc_attr($tel); ?>" />
            </td>
        </tr>
    ...
    ?>
        ...
        <div class="form-field">
            <label for="mec_tel"><?php esc_html_e('Location Phone', 'mec'); ?></label>
            <input type="tel" name="tel"  placeholder="<?php esc_attr_e('Location Phone (Optional)', 'mec'); ?>" id="mec_tel" value="" />
        </div>
