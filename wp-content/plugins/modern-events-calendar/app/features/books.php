    ...
    public function meta_box_booking_info($post)
    {
        ...
        <div class="mec-book-details">
            <div class="mec-form-row">
                ...
                <div class="mec-col-2" style="text-align: right;"><a href="#mec_booking_edit_heading"
                                                                     class="button"><?php esc_html_e('Go to Edit Form', 'mec'); ?></a>
                </div>
            </div>
            <div class="mec-row">
        ...
        foreach ($bookings as $booking)
        {
            ...
            if (is_array($all_dates) && count($all_dates))
            {
                ...
                foreach ($all_dates as $all_date)
                {
                    ...
                    $dates[$ds] = $this->main->date_i18n($datetime_format, $ds);
                }
            }
            else $dates[strtotime($booking->post_date)] = $booking->post_date;
        }
