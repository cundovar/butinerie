...
$time = (get_post_meta(get_the_ID(), 'mec_allday', true) == '1')
...
<article class="mec-search-bar-result">
    <div class="mec-event-list-search-bar-date mec-color">
        <span class="mec-date-day">
			<?php echo esc_html($this->main->date_i18n('d', strtotime(get_post_meta(get_the_ID(), 'mec_start_date', true)))); ?>
		</span>
		<?php echo esc_html($this->main->date_i18n('F', strtotime(get_post_meta(get_the_ID(), 'mec_start_date', true)))); ?>
    </div>
