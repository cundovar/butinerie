...
class MEC_feature_faq extends MEC_base
{
    ...
    public function meta_box_faq($post)
    {
        ...
        <div class="mec-meta-box-fields mec-event-tab-content" id="mec-faq">
            <h4><?php esc_html_e('FAQ', 'mec'); ?></h4>
            <div class="mec-faq-wrapper mec-form-row">
                <div>
                    <button id="mec_add_faq_button" type="button" class="button mec-button-new"><?php esc_attr_e('Add', 'mec'); ?></button>
                </div>
                <ul class="mec-faq-list" id="mec_faq_list">
                    ...
                    <li class="mec-box mec_faq_row" id="mec_faq_row<?php echo $i; ?>">
                        <div class="mec-faq-actions">
                            <ul>
                                <li><button class=" button mec-faq-remove" onclick="mec_faq_remove(<?php echo $i; ?>)"><?php esc_html_e("Remove", 'mec'); ?></button></li>
                            </ul>
                        </div>
                        <div class="mec-faq-data">
                            <div class="mec-faq-data-row mec-form-row">
                                <div class="mec-col-3">
                                    <label for="mec_faq<?php echo $i; ?>_title"><?php esc_html_e("FAQ Title", 'mec'); ?></label>
                                </div>
                                <div class="mec-col-7">
                                    <input type="text" class="mec-col-12" name="mec[faq][<?php echo $i; ?>][title]" placeholder="<?php esc_attr_e('Title Here', 'mec'); ?>" value="<?php echo esc_attr($faq['title']); ?>">
                                </div>
                            </div>
                            <div class="mec-faq-data-row mec-form-row">
                                <div class="mec-col-3">
                                    <label for="mec_faq<?php echo $i; ?>_body"><?php esc_html_e("FAQ Content", 'mec'); ?></label>
                                </div>
                                <div class="mec-col-7">
                                    <textarea type="text" class="mec-col-12" name="mec[faq][<?php echo $i; ?>][body]" placeholder="<?php esc_attr_e('FAQ Content Here', 'mec'); ?>"><?php echo esc_textarea($faq['body']); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="mec-util-hidden" id="mec_new_faq_raw">
                <li class="mec-box mec_faq_row" id="mec_faq_row:i:">
                    <div class="mec-faq-actions">
                        <ul>
                            <li><button class="button mec-faq-remove" onclick="mec_faq_remove(:i:)"><?php esc_html_e("Remove", 'mec'); ?></button></li>
                        </ul>
                    </div>
                    <div class="mec-faq-data">
                        <div class="mec-faq-data-row mec-form-row">
                            <div class="mec-col-3">
                                <label for="mec_faq:i:_title"><?php esc_html_e("FAQ Title", 'mec'); ?></label>
                            </div>
                            <div class="mec-col-7">
                                <input type="text" class="mec-col-12" name="mec[faq][:i:][title]" placeholder="<?php esc_attr_e('Title Here', 'mec'); ?>">
                            </div>
                        </div>
                        <div class="mec-faq-data-row mec-form-row">
                            <div class="mec-col-3">
                                <label for="mec_faq:i:_body"><?php esc_html_e("FAQ Content", 'mec'); ?></label>
                            </div>
                            <div class="mec-col-7">
                                <textarea type="text" class="mec-col-12"     name="mec[faq][:i:][body]" placeholder="<?php esc_attr_e('FAQ Content Here', 'mec'); ?>"></textarea>
                            </div>
                        </div>
                    </div>
                </li>
