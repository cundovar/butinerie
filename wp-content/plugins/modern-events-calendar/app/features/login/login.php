<div class="mec-login-form" id="mec-login-form">
    <div class="mec-login-input">
        <label>
            ...
            <input name="email" id="email" type="text" title="<?php esc_attr_e('Email', 'mec'); ?>">
        </label>
    </div>
    <div class="mec-login-input">
        <label>
            <i class="mec-sl-key"></i>
            <input name="password" id="password" type="password" title="<?php esc_attr_e('Password', 'mec'); ?>">
    ...
    <div class="mec-login-form-footer">
        <div class="mec-login-forgotpassword">
            <a class="mec-color-hover" href="<?php echo wp_lostpassword_url(); ?>"><?php esc_html_e('Forgot Password?', 'mec'); ?></a>
        </div>
        <div class="mec-login-submit">
            <button class="mec-bg-color mec-box-shadow-color"><?php esc_html_e('Login', 'mec'); ?></button>
        </div>
    </div>
