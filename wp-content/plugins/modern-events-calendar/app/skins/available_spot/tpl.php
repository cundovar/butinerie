    ...
    <div class="mec-av-spot-wrap">
        ...
        <div class="mec-av-spot">
            <article class="<?php echo (isset($event->data->meta['event_past']) and trim($event->data->meta['event_past'])) ? 'mec-past-event ' : ''; ?>mec-event-article mec-clear <?php echo esc_attr($this->get_event_classes($event)); ?>">
                ...
                <div class="mec-av-spot-img" style="background-image: url('<?php echo esc_url($event_thumb_url); ?>');"></div>
                <?php endif; ?>
                ...
                <div class="mec-av-spot-head clearfix">
                    <div class="mec-av-spot-col6">
                        <div class="mec-av-spot-box"><?php esc_html_e('Available Spot(s):', 'mec'); ?> <span class="mec-av-spot-count mec-color"><?php echo ($spots != '-1' ? $spots : esc_html__('Unlimited', 'mec')); ?></span></div>
                    </div>
                    <div class="mec-av-spot-col6">
                ...
                <div class="mec-av-spot-content mec-event-grid-modern">
                    ...
                    <div class="mec-event-footer">
                        <?php echo MEC_kses::element($this->display_link($event, $this->main->m('register_button', esc_html__('REGISTER', 'mec')), 'mec-booking-button')); ?>
                    </div>
                </div>
            </article>
        </div>
