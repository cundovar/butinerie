...
if ($d3 < $d2) {
    echo '<div class="mec-end-counts"><h3>' . esc_html__('The event is finished.', 'mec') . '</h3></div>';
    return;
} elseif (($d1 < $d2 and !$ongoing) or ($d1 < $d2 and $disable_for_ongoing)) {
    echo '<div class="mec-end-counts"><h3>' . esc_html__('The event is ongoing.', 'mec') . '</h3></div>';
    return;
}
