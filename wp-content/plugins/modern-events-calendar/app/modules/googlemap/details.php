...
<div class="mec-get-direction">
    <form method="post" action="#" id="mec_get_direction_form<?php echo esc_attr($uniqueid); ?>" class="clearfix">
        <div class="mec-map-get-direction-address-cnt">
            <input class="mec-map-get-direction-address" type="text" placeholder="<?php esc_attr_e('Address from ...', 'mec') ?>" id="mec_get_direction_addr<?php echo esc_attr($uniqueid); ?>" />
        ...
        <div class="mec-map-get-direction-btn-cnt btn btn-primary">
            <input type="submit" value="<?php esc_html_e('Get Directions', 'mec'); ?>" />
        </div>
    </form>
</div>
<?php endif;
