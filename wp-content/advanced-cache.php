...
// WP-Optimize advanced-cache.php (written by version: 4.2.4) (homeurl: http://localhost/butinerie/wordpress/) (abspath: /var/www/html/butinerie/wordpress/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'/var/www/html/butinerie/wordpress/wp-content/plugins/wp-optimize/cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/butinerie/wordpress/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', '/var/www/html/butinerie/wordpress/wp-content/plugins/wp-optimize/cache/extensions');
}
